        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                @else
                    <li class="nav-item dropdown">
                        <div class="dropdown-close-tag">
                            ...
                            <div class="dropdown-menu dropdown-menu-right theme mb-1" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item theme" href="{{ url('/list-users') }}"><i class="fas fa-users"></i> Users</a>
                                                              
                                <a class="dropdown-item theme" href="{{ url('/list-items') }}"><i class="fas fa-compact-disc pt-1 pr-2"></i> Posts</a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/admin') }}"><i class="fa fa-camera-retro pt-1 pr-2"></i></a>
                    </li>
                @endguest
            </ul>
        </div>
